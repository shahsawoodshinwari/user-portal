...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      !this.form.email? (this.errors.email = 'The email field is required.'): (this.errors.email = '')
      !this.form.terms? (this.errors.terms = 'You must accept terms & conditions'): (this.errors.terms = '')
    ...
    <form @submit.prevent="onSubmit" class="row g-3" novalidate>
      ...
      <div class="col-12">
        <div class="form-check form-switch">
          <input v-model="form.terms" :class="['form-check-input', errors.terms ? 'is-invalid' : null]"type="checkbox"role="switch"id="terms"/>
          <label class="form-check-label" for="terms">I accept the <a href="#">terms</a> and conditions.</label>
